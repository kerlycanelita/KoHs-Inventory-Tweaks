...
/** Every Vanilla inventory surface available in the target Minecraft version. */
public enum CustomizationPreview {
	...
	NAUTILUS("nautilus", "nautilus.png", 176, 166,
		withPlayer(84, grid(62, 17, 3, 2))),
	...
	CustomizationPreview(
		...
		this(
			id,
			Kind.SURFACE,
			Identifier.withDefaultNamespace("textures/gui/container/" + textureFile),
			width,
			height,
			textureWidth,
			textureHeight,

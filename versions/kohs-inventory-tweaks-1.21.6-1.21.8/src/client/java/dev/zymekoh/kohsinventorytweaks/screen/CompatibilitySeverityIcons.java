...
final class CompatibilitySeverityIcons {
	private static final ResourceLocation ADAPTED = texture("severity_adapted.png");
	private static final ResourceLocation WARNING = texture("severity_warning.png");
	private static final ResourceLocation CRITICAL = texture("severity_critical.png");

	private CompatibilitySeverityIcons() {
	}

	static ResourceLocation textureFor(final CompatibilityIssue.Severity severity) {

...
public final class IssuesTrackerScreen extends Screen {
	...
	private void drawIssues(final GuiGraphics graphics) {
	...
	private void drawIssueCard(
		...
		if (icon != null) {
			...
			graphics.drawCenteredString(this.font, Component.literal("!"), x + 9 + iconSize / 2, y + 10 + (iconSize - 8) / 2, UiTheme.WARNING);
		}

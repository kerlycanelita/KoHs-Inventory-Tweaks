...
public final class MouseConflictNotificationController {
	...
	public static void onClientTick(final Minecraft minecraft) {
		...
		if (!started) {
			if (minecraft == null || minecraft.level == null || minecraft.player == null || minecraft.gui.screen() != null) {
				return;
			}
			started = true;
	...
	public static void draw(final GuiGraphicsExtractor graphics) {
		Minecraft minecraft = Minecraft.getInstance();
		if (!isVisible() || minecraft.gui.screen() != null) {
			return;
		}
